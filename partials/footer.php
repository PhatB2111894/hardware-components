        ...
        <section class="d-flex justify-content-center justify-content-lg-between p-3 border-bottom">
            ...
            <div>
                <a href="" class="me-4 text-reset">
                    <i class="text-color text-decoration-none fab fa-facebook-f"></i>
                </a>
                <a href="" class="me-4 text-reset">
                    <i class="text-color text-decoration-none fab fa-twitter"></i>
                </a>
                <a href="" class="me-4 text-reset">
                    <i class="text-color text-decoration-none fab fa-google"></i>
                </a>
                <a href="" class="me-4 text-reset">
                    <i class="text-color text-decoration-none fab fa-instagram"></i>
                </a>
                <a href="" class="me-4 text-reset">
                    <i class="text-color text-decoration-none fab fa-linkedin"></i>
                </a>
                <a href="" class="me-4 text-reset">
                    <i class="text-color text-decoration-none fab fa-github"></i>
                </a>
            </div>
            <!-- Right -->
        </section>
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p class="footer-item">
                            <a href="./hoa.php?id=hoa#" class="text-reset text-decoration-none">Thiết bị điện tử </a>
                        </p>
                        <p class="footer-item">
                            <a href="./hoacuoi.php?id=hoacuoi#" class="text-reset text-decoration-none">Linh kiện điện tử</a>
                        </p>
                        <p class="footer-item">
                            <a href="./cart.php" class="text-reset text-decoration-none">Giỏ Hàng</a>
                        </p>
                    </div>
                    <!-- Grid column -->
